...
public class IngredientLineAdapter
    ...
    static class IngredientViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(@NonNull IngredientLine line) {
            RecipeIngredient ingredient = line.getIngredient();

            nameView.setText(ingredient.getName());
            amountView.setText(formatAmount(ingredient.getQuantity(), ingredient.getUnit()));
        ...
        /** Renders an amount without a pointless trailing ".0". */
